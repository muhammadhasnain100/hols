  ...
  return (
    <Section variant="default">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-brand-subheading text-primary">{pillars.headline}</h2>
      </div>
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {pillars.items.map((item, index) => (
          <article
            key={item.title}
            className="rounded-2xl border border-border/50 bg-white p-6 shadow-sm transition-shadow hover:shadow-md"
          >
            <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-primary/5 text-primary-light">
              <svg
                className="h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
                ...
                aria-hidden
              >
                <path strokeLinecap="round" strokeLinejoin="round" d={pillarIcons[index]} />
              </svg>
            </div>
