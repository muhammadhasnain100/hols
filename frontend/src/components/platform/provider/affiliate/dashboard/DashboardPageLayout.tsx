      ...
      <div className="dashboard-screen lectures-page min-w-0 overflow-x-hidden">
        <header className="mb-4 flex min-h-10 min-w-0 items-center gap-2 sm:mb-5 sm:min-h-12 sm:gap-3 md:gap-4">
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-2.5">
            ...
            <WelcomeChip
              fallbackName="Affiliate"
              tone="navy"
              className="lecture-header-welcome hidden h-10 min-[420px]:flex sm:h-12"
            />
          </div>
        </header>

        <div className="grid w-full min-w-0 gap-3 sm:gap-4 xl:grid-cols-[minmax(0,1.9fr)_minmax(0,1fr)] xl:items-stretch">
          {children}
        </div>
      </div>
    </PortalShell>
