...
export {
  ...
  StudentLessonsPage,
  StudentLessonPage,
} from "@/components/platform/provider/student/lectures";
export { StudentPeptideCalculatorPage } from "@/components/platform/provider/student/calculator";
export { studentNav } from "@/components/platform/provider/student/studentNav";
