...
const ICON_PATHS: Record<SidebarIconName, React.ReactNode> = {
  ...
  notification: (
    <>
      <path d="M6.5 9.5a5.5 5.5 0 0 1 11 0v2.55c0 .52.14 1.04.4 1.5l.85 1.5c.5.9.17 2.05-.78 2.45a15.7 15.7 0 0 1-11.94 0c-.95-.4-1.28-1.55-.78-2.45l.85-1.5c.26-.46.4-.98.4-1.5V9.5Z" />
...
export function PortalNavIcon({
  ...
  return (
    <span className="portal-nav-icon flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-transparent text-current transition-colors duration-200">
