        ...
        "stages": [
            {
                ...
                "questions": [
                    {"id": "age", "text": "Patient age", "type": "number", "min": 1, "max": 100, "required": True},
                    ...
                    {"id": "height_cm", "text": "Height (cm)", "type": "number", "min": 45, "max": 220, "required": True},
                    {"id": "weight_kg", "text": "Weight (kg)", "type": "number", "min": 4, "max": 300, "required": True},
